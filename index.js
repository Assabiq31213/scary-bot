...
console.log(color('[JESSICA MD]', 'cyan'))

console.log(color(figlet.textSync('JESSICA BOTZ', {
font: 'Elite',
horizontalLayout: 'default',
vertivalLayout: 'default',
width: 80,
whitespaceBreak: false }), 'red'))
		
console.log(color('[JESSICA MD]', 'cyan'), color('OWNER SEDANG ONLINE SEKARANG!', 'yellow'))

console.log(color('[JESSICA MD]', 'cyan'), color('SELAMAT DATANG OWNER ><', 'yellow'))
