...
Selama ${clockString(new Date - user.afkTime)}`)
        ...
        const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 99999,status: 200, thumbnail: await reSize(thumb, 100, 100), surface: 200, message: `BiqqTzy`, orderTitle: 'BiqqTzy', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		const fdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: `BiqqTzy`,jpegThumbnail: await reSize(thumb, 100, 100)}}}
		const fvn = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":359996400,"ptt": "true"}} } 
		const ftextt = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})}, message: { "extendedTextMessage": {"text":`BiqqTzy`, "title": `${namabot}`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
        const ftoko = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? {remoteJid: "status@broadcast" } : {})}, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": await reSize(thumb, 100, 100)},"title": `BiqqTzy`, "description": `${namabot}`, "currencyCode": "IDR", "priceAmount1000": "1000000000000000000", "retailerId": `BiqqTzy`, "productImageCount": 1}, "businessOwnerJid": `0@s.whatsapp.net`}}} 
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":`BiqqTzy`, "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': `BiqqTzy`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": `BiqqTzy`, "caption": `BiqqTzy`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title":`BiqqTzy`, "h": `Hmm`,'seconds': '359996400', 'caption': `BiqqTzy`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
		const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `BiqqTzy`,jpegThumbnail: await reSize(thumb, 100, 100)}}}
		const floc2 = {key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) }, message: { "liveLocationMessage": { "title": `BiqqTzy`,"h": `Hmm`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': `BiqqTzy`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;ytname,;;;\nFN:ytname\nitem1.TEL;waid=6289512545999:6289512545999\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': await reSize(thumb, 100, 100), thumbnail: await reSize(thumb, 100, 100),sendEphemeral: true}}}
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": `BiqqTzy`,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": await reSize(thumb, 100, 100),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
m.reply(mess.wait)
let res = await fetchJson(`https://api.akuari.my.id/downloader/youtube3?link=${q}&type=360`)
danzz.sendMessage(m.chat, { audio: { url: res.audio.audio }, mimetype: 'audio/mpeg', fileName: `${res.title}.mp3` }, { quoted: m })
}
break
...
m.reply(mess.wait)
let res = await fetchJson(`https://api.akuari.my.id/downloader/youtube3?link=${q}&type=360`)
let cap = `あ Title : ${res.title}\nあ File Size : ${res.size}\nあ Url : ${isUrl(text)}\nあ Ext : MP4\nあ Resolusi : ${res.type_download}`
danzz.sendMessage(m.chat, { video: { url: res.mp4.download }, caption: cap ,mimetype: 'video/mp4', fileName: `${res.title}.mp4` }, { quoted: m })
}
break
...
reply(mess.wait)
let p = await caliph.downloader.tiktok(q)
let nih = ` Nihh kakk >_<`
let button = [
...
let buttonsMessage = {
video: { url: p.nowm },
caption: `Jika ingin merubah menjadi audio, klik tombol dibawah`,
title: 'TIKTOK DOWNLOADER',
footer: `© ${setting.botName} bot`,
buttons: button,
headerType: 5
}
danzz.sendMessage(from, buttonsMessage, { quoted: m })
break
case 'tiktokmp3': 
case 'tiktokaudio': {
if (!text) return reply( `Example : ${prefix + command} link`)
reply(mess.wait)
let aud = await caliph.downloader.tiktok(text)
let cap = `Nihh Kak👇`
danzz.sendMessage(from, { caption: cap, image: {url: aud.thumbnail}})
danzz.sendMessage(from, { audio: { url: aud.audio }, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
...
m.reply(mess.wait)
let urlnya = q
bocil.instagramdlv2(urlnya)
.then(async(result) => {
for(let i of result){
if(i.url.includes('mp4')){
let link = await getBuffer(i.thumbnail)
danzz.sendMessage(m.chat, { video: link, }, { quoted: m })
} else {
let link = await getBuffer(i.thumbnail)
danzz.sendMessage(m.chat, { image: link, }, { quoted: m })                  
}
}
...
danzz.sendMessage(m.chat, buttonMssage, { quoted: m })
break
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await danzz.sendButtonText(m.chat, buttons, `Mode Antilink`, global.footer, m)
                }
             }
             break
             case 'mute': {
